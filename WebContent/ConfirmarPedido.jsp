 ...
 <header id="header" id="home">
			...
			<section class="home-about-area section-gap">
				<div class="container">
					<div class="row">
						<div class="col-lg-9">
							<h1 class="col-md-12 pb-80 header-text text-center">Gracias por tu pedido ${nombre}</h1>
							<p>
								<span>Por último ¿a qué hora recogerás tu pedido?</span>
							</p>
							<div>
							<form action="confirmarHora" method ="post">
							<div class="form-group">
        								<label for="inputHora">Name</label>
       									 <input type="text" class="form-control" id="inputHora" placeholder="Escribe la hora" name="hora">
    							</div>
    							<button type="submit" class="btn btn-primary">Confirmar</button>
							</form>
							</div>
							<h1 class="col-md-12 pb-80 header-text text-center">No olvides que puedes pagar con efectivo o tarjetas excepto American Express</h1>			
						</div>
					</div>
				</div>	
			</section>
